...
fdescribe('Current Weather Model', () => {
  ...
  it('fromJson should build a CurrentWeatherModel with correctly assigned properties from the JSON object', () => {
    ...
    let expectedWeatherStateName = "Showers";
    let expectedWeatherStateAbbr = "s";
    let expectedMinTemp = -3.5219999999999998;
    let expectedMaxTemp = 5.2275000000000009;
    let expectedTheTemp = 1.6899999999999999;
    let expectedWindSpeed = 8.5681496927177285;
    let expectedWindDirection = "NNW";
    ...
    let currentWeatherModel = CurrentWeather.fromJson(weatherJson);
  ...
  it('fromJson should return an empty CurrentWeatherModel if given an empty JSON object', () => {
    ...
    let currentWeatherModel = CurrentWeather.fromJson({});
